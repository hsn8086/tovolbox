...
const dataTools = new Set(['json-formatter', 'json-minifier', 'json-to-csv', 'csv-to-json', 'query-string-parser', 'query-string-builder']);
const textTools = new Set(['word-counter', 'case-converter', 'slug-generator', 'extract-emails', 'extract-urls', 'extract-numbers', 'remove-empty-lines', 'deduplicate-lines', 'sort-lines', 'trim-lines', 'find-replace', 'markdown-toc']);
